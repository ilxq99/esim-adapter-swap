...
const Hero = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-purple-50 to-indigo-50 py-20 lg:py-32">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <Button
                asChild
                size="lg"
                className="bg-gradient-to-r from-primary to-indigo-600 hover:from-primary/90 hover:to-indigo-600/90 text-white shadow-lg hover:shadow-xl transition-all duration-300 px-8 py-4 text-lg font-semibold"
              >
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-2 border-slate-300 hover:border-primary hover:bg-primary/5 transition-all duration-300 px-8 py-4 text-lg font-semibold"
              >
